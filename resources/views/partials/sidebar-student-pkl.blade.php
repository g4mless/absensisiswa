...
>
    ...
    <div class="flex h-16 items-center gap-3 border-b border-gray-200 px-6">
        ...
        <div>
            ...
            <p class="text-[10px] text-gray-400">Panel Siswa PKL</p>
        </div>
    </div>
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4">
        <div class="space-y-1">
            {{-- Dashboard --}}
            <a href="{{ route('student-pkl.dashboard') }}" class="{{ request()->routeIs('student-pkl.dashboard') ? 'md-sidebar-link-active' : 'md-sidebar-link' }}">
                <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25"/></svg>
                <span>Dashboard</span>
            </a>

            {{-- Attendance --}}
            <a href="{{ route('student-pkl.attendance') }}" class="{{ request()->routeIs('student-pkl.attendance') ? 'md-sidebar-link-active' : 'md-sidebar-link' }}">
            ...
            {{-- Location --}}
            <a href="{{ route('student-pkl.location') }}" class="{{ request()->routeIs('student-pkl.location') ? 'md-sidebar-link-active' : 'md-sidebar-link' }}">
                <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z"/></svg>
                <span>Lokasi GPS</span>
            </a>

            {{-- History --}}
            <a href="{{ route('student-pkl.history') }}" class="{{ request()->routeIs('student-pkl.history') ? 'md-sidebar-link-active' : 'md-sidebar-link' }}">
            ...
            {{-- Profile --}}
            <a href="{{ route('student-pkl.profile') }}" class="{{ request()->routeIs('student-pkl.profile') ? 'md-sidebar-link-active' : 'md-sidebar-link' }}">
...
<nav class="fixed bottom-0 left-0 right-0 z-50 border-t border-gray-200 bg-white lg:hidden">
    <div class="flex items-center justify-around py-2">
        <a href="{{ route('student-pkl.dashboard') }}" class="flex flex-col items-center gap-0.5 px-3 py-1.5 {{ request()->routeIs('student-pkl.dashboard') ? 'text-primary-600' : 'text-gray-500' }}">
            <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25"/></svg>
            <span class="text-[10px] font-medium">Beranda</span>
        </a>
        <a href="{{ route('student-pkl.attendance') }}" class="flex flex-col items-center gap-0.5 px-3 py-1.5 {{ request()->routeIs('student-pkl.attendance') ? 'text-primary-600' : 'text-gray-500' }}">
        ...
        <a href="{{ route('student-pkl.location') }}" class="flex flex-col items-center gap-0.5 px-3 py-1.5 {{ request()->routeIs('student-pkl.location') ? 'text-primary-600' : 'text-gray-500' }}">
            <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z"/></svg>
            <span class="text-[10px] font-medium">Lokasi</span>
        </a>
        <a href="{{ route('student-pkl.history') }}" class="flex flex-col items-center gap-0.5 px-3 py-1.5 {{ request()->routeIs('student-pkl.history') ? 'text-primary-600' : 'text-gray-500' }}">
        ...
        <a href="{{ route('student-pkl.profile') }}" class="flex flex-col items-center gap-0.5 px-3 py-1.5 {{ request()->routeIs('student-pkl.profile') ? 'text-primary-600' : 'text-gray-500' }}">
