...
<div class="max-w-2xl mx-auto">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mt-2">Tambah Tahun Akademik Baru</h1>
    </div>
    ...
    <x-card>
        <form action="{{ route('admin.academic-years.store') }}" method="POST">
            @csrf
            <div class="space-y-4">
                <x-input label="Tahun" name="year" :error="$errors->first('year')" value="{{ old('year') }}" placeholder="contoh: 2025/2026" />
            ...
            <div class="flex items-center gap-3 mt-6">
                <x-button variant="primary" type="submit">Buat Tahun Akademik</x-button>
