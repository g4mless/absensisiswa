...
<div class="space-y-6" x-data="{
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex flex-col items-stretch sm:items-end gap-2">
            ...
            <div x-show="selected.length > 0" x-cloak class="flex flex-wrap items-center justify-end gap-2">
                <span class="text-sm text-primary-700" x-text="selected.length + ' dipilih'"></span>
