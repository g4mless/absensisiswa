    ...
    <x-card>
        <form action="{{ route('admin.teachers.update', $teacher) }}" method="POST">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center gap-2">
                    <input type="checkbox" name="is_active" value="1" {{ old('is_active', $teacher->is_active) ? 'checked' : '' }} class="rounded border-gray-300 text-primary-600 focus:ring-primary-500" />
